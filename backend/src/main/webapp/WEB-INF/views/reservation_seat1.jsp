...
<html lang="ko">
  <head>
    ...
    <link rel="stylesheet" href="/resources/css/reservation_seat1.css" />
          ...
          <div class="container">
            <div id="seat_map_wrap">
              <div class="seat-map1">
                ...
                <div class="seat" id="seat-13">17</div>
                <div class="seat" id="seat-14">18</div>
                <div class="seat-blank"></div>
                <div class="seat" id="seat-15">19</div>
                <div class="seat" id="seat-16">20</div>

                <div class="seat" id="seat-13">21</div>
                <div class="seat" id="seat-14">22</div>
                <div class="seat-blank"></div>
                <div class="seat" id="seat-15">23</div>
                <div class="seat" id="seat-16">24</div>

                <div class="seat" id="seat-13">25</div>
                <div class="seat" id="seat-14">26</div>
                <div class="seat-blank"></div>
                <div class="seat" id="seat-15">27</div>
                <div class="seat" id="seat-16">28</div>

                <div class="seat" id="seat-13">29</div>
                <div class="seat" id="seat-14">30</div>
                <div class="seat-blank"></div>
                <div class="seat" id="seat-15">31</div>
                <div class="seat" id="seat-16">32</div>

                <div class="seat" id="seat-13">33</div>
                <div class="seat" id="seat-14">34</div>
                <div class="seat-blank"></div>
                <div class="seat" id="seat-15">35</div>
                <div class="seat" id="seat-16">36</div>

                <div class="seat" id="seat-13">37</div>
                <div class="seat" id="seat-14">38</div>
                <div class="seat-blank"></div>
                <div class="seat" id="seat-15">39</div>
                <div class="seat" id="seat-16">40</div>

                <div class="seat" id="seat-13">41</div>
                <div class="seat" id="seat-14">42</div>
                <div class="seat" id="seat-16">43</div>
                <div class="seat" id="seat-15">44</div>
                <div class="seat" id="seat-16">45</div>
